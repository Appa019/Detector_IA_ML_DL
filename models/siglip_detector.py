"""
Detector SigLIP binario baseado em 'Ateeqq/ai-vs-human-image-detector'.

Classificador binario IA vs Humano usando SiglipForImageClassification.
...
_HUB_ID = "Ateeqq/ai-vs-human-image-detector"


class DetectorSigLIP(DetectorBase):
    """
    Detector SigLIP binario para classificacao IA vs Humano.

    Utiliza SiglipForImageClassification fine-tuned para distinguir
    imagens geradas por IA de imagens criadas por humanos.
    ...
    def __init__(self) -> None:
        super().__init__(
            id_modelo="siglip_detector",
            nome_modelo="SigLIP AI vs Human",
        )
    ...
    def carregar(self, dispositivo: str = "cuda") -> None:
        """
        Carrega o processador e modelo SigLIP do HuggingFace Hub em FP16.
        ...
        try:
            ...
            raise RuntimeError(
                f"Nao foi possivel carregar o modelo SigLIP de '{_HUB_ID}': {excecao}"
            ) from excecao
    ...
    def detectar(self, imagem: Image.Image) -> ResultadoDeteccao:
        """
        Executa inferencia SigLIP na imagem e retorna score de IA.
