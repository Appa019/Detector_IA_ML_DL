"""
Detector de imagens geradas por IA baseado em 'umm-maybe/AI-image-detector'.

Modelo ViT treinado em Midjourney/SD/DALL-E com 94.2% accuracy e 97.8% recall.
Segue o mesmo padrao do DetectorSDXL (AutoModelForImageClassification).
"""
...
_HUB_ID = "umm-maybe/AI-image-detector"


class DetectorAIImage(DetectorBase):
    """
    Detector ViT treinado para identificar imagens geradas por IA.

    Treinado em datasets de Midjourney, Stable Diffusion e DALL-E.
    Alta accuracy (94.2%) e recall (97.8%).
    ...
    def __init__(self) -> None:
        super().__init__(
            id_modelo="ai_image_detector",
            nome_modelo="AI Image Detector (ViT)",
        )
    ...
    def carregar(self, dispositivo: str = "cuda") -> None:
        """
        Carrega o processador e modelo AI Image Detector do HuggingFace Hub em FP16.
        ...
        try:
            ...
            raise RuntimeError(
                f"Nao foi possivel carregar o modelo de '{_HUB_ID}': {excecao}"
            ) from excecao
    ...
    def detectar(self, imagem: Image.Image) -> ResultadoDeteccao:
        """
        Executa inferencia na imagem e retorna score de IA.
        ...
        try:
            ...
            metadados = {
                "hub_id": _HUB_ID,
                "arquitetura": "ViT (AI Image Detector)",
    ...
    def _extrair_score_ia(
        ...
        """
        _termos_ia = {"fake", "ai", "synthetic", "generated", "artificial"}
